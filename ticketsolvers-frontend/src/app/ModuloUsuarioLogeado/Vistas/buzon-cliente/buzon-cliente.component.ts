...
@Component({
  selector: 'app-buzon-cliente',
  templateUrl: './buzon-cliente.component.html',
  styleUrls: ['./buzon-cliente.component.css']
})
export class BuzonClienteComponent  {
...
//   dataSource = new ExampleDataSource(this.dataToDisplay);
    ...
    open_CrearTicket_Dialog_buzon(): void 
    {
        const dialogIngresarRef = this.dialog.open(CrearTicketComponent, {data: {},});
